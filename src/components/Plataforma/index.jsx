...
export default function Plataforma() {
    return (
        <section>
            <header>
                 <NavLink to="/plataforma"><img src="../Logotipo WeStudy.png" alt="Logotipo WeStudy"/></NavLink>
                <nav>
                    
                    <NavLink to="/guias">Guias</NavLink>
                    <NavLink to="/sessoes">Sessões</NavLink>
                    <NavLink to="/cadernos">Cadernos</NavLink>
                    <a href="#"><img src="../Icones/Grupo.svg" class="icone" alt=""/></a>
                    <a href="#"><img src="../Icones/Notificação.svg" class="icone" alt=""/></a>
                    <button id="btn-menu">
